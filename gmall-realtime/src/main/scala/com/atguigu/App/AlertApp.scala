...
import com.atguigu.Util.{MyEsUtil, MykafkaUtil2}
...
object AlertApp {
  def main(args: Array[String]): Unit = {
    ...
    val kafkaDStream: InputDStream[ConsumerRecord[String, String]] = MykafkaUtil2.getKafkaStream(GmallConstants.GMALL_TOPIC_EVENT, ssc)
    ...
    filterAlertDStream.foreachRDD(rdd => {
      ...
      rdd.foreachPartition(iter => {
        ...
        MyEsUtil.insertByBulk(GmallConstants.GMALL_ES_ALERT_INFO_PRE + "_" + date,"_doc",docIdToData.toList)
